...
TECHNO_IMG = "https://images.app.goo.gl/nfwhaajJzn7efuyH7"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/SOMA00")],
                                                                                   [InlineKeyboardButton(text="ADD SOMA00 BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Subhradeep00/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("ZINDA HU YAAR 🙃")
